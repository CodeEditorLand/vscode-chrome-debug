		...
		async (_context, page) => {
			...
			await validateStackTrace({
				...
				expectedFrames: [
					...
					{
						name: new RegExp(`\\(${EVAL}\\) \\[VM\\d+] Line 1`),
						line: 1,
						column: 1,
						source: { evalCode: true },
						presentationHint: "normal",
