	...
	(suiteContext) => {
		puppeteerTest(
			...
			async (_context, page) => {
				...
				await setStateBreakpoint.assertIsHitThenResumeWhen(() =>
					incBtn.click()
				);
		...
		puppeteerTest(
			...
			async (_context, page) => {
				...
				await stepInBreakpoint.assertIsHitThenResumeWhen(() =>
					incBtn.click()
				);
				await setNewValBreakpoint.assertIsHitThenResumeWhen(() =>
					incBtn.click()
				);
